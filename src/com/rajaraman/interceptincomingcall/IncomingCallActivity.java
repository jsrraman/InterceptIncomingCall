...
public class IncomingCallActivity extends Activity {
	...
	Log.d(GlobalConstants.TAG, "Starting incoming call service");

	bindService(new Intent(this, IncomingCallService.class), mConnection,
	...
	Log.d(GlobalConstants.TAG, "onResume start");
	...
	Log.d(GlobalConstants.TAG, "onResume end");
    }
	...
	Log.d(GlobalConstants.TAG, "answerPhoneHeadsetHook start");
	...
	Log.d(GlobalConstants.TAG, "Call Answered");
    }
	...
	Log.v(GlobalConstants.TAG, "Now disconnecting using ITelephony....");

	TelephonyManager telephony = (TelephonyManager) context
		.getSystemService(Context.TELEPHONY_SERVICE);
	try {
	    Log.v(GlobalConstants.TAG, "Get getTeleService...");
	    ...
	    // telephonyService.silenceRinger();
	    Log.v(GlobalConstants.TAG, "Disconnecting Call now...");

	    // telephonyService.answerRingingCall();
	    // telephonyService.endcall();

	    Log.v(GlobalConstants.TAG, "Call disconnected...");
	    telephonyService.endCall();
	} catch (Exception e) {
	    e.printStackTrace();
	    Log.e(GlobalConstants.TAG, "FATAL ERROR: could not connect to telephony subsystem");
	    Log.e(GlobalConstants.TAG, "Exception object: " + e);
	}
    }
