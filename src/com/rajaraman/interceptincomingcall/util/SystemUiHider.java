package com.rajaraman.interceptincomingcall.util;
...
public abstract class SystemUiHider {
   ...
   * {@link android.view.WindowManager.LayoutParams#FLAG_LAYOUT_IN_SCREEN} flag will be set on older
   * devices, making the status bar "float" on top of the activity layout. This is most useful when
   * there are no controls at the top of the activity layout.
   * <p>
   * This flag isn't used on newer devices because the <a
   * href="http://developer.android.com/design/patterns/actionbar.html">action bar</a>, the most
  ...
  /**
   * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the
   * status bar. If there is a navigation bar, show and hide will toggle low profile mode.
   */
  public static final int FLAG_FULLSCREEN = 0x2;

  /**
   * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the
   * navigation bar, if it's present on the device and the device allows hiding it. In cases where
   * the navigation bar is present but cannot be hidden, show and hide will toggle low profile mode.
   */
  ...
  /**
   * Creates and returns an instance of {@link SystemUiHider} that is appropriate for this device.
